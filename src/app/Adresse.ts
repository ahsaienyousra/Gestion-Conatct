...
export class Adresse {
    ...
    public get getCommentaire(): string {
        return this.commentaire;
    }
    public set setCommentaire(commentaire: string){
        this.commentaire=commentaire;
    }
    public get getContactNo(): string {
